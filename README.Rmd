...
The goal of annotater is to annotate package load calls in text strings and R/Rmd files, so we can have an idea of the overall purpose of the libraries we're loading.

The other main feature helps us annotate the package load calls with their respective repositories and versions. Thanks to [Jonathan Carroll](https://github.com/jonocarroll) for the suggestion. 
